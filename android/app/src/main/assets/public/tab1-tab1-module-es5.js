  ...
  function srcAppTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Tab1Page = /*#__PURE__*/function () {
      function Tab1Page() {
        ...
        this.festMode = false;
        this.headphonesItems = ['Conectá tus auriculares', 'Subí el volumen', 'Aumentá el brillo de tu pantalla', 'Apagá las luces', 'Cerrá los ojos', 'Acercá la pantalla de tu teléfono a tus ojos', 'Disfrutá la Experiencia Boliche!'];
        this.festItems = ['Subí el volumen de tu dispositivo', 'Aumentá el brillo de tu pantalla', 'Apagá las luces', 'Reproduce una canción desde "Experiencia"', 'Apoyá tu teléfono en una mesa', 'Disfrutá la Experiencia Boliche!'];
      }
